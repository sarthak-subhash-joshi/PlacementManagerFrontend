...
<div className="container">
	<div className="left-section">
      ...
      <NavLink className="nav-link go-back" to='/' >
       <span style={{background:'#E8F9FD',padding:'10px',margin:'10px',borderRadius:'30px',color:'#000',textDecoration:'none' }}><i class="fa-solid fa-arrow-left"></i> Go to Home</span>
      </NavLink>
