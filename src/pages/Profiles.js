  ...
  const fetchRecordCount = async () => {
    try {
      const response = await axios.get(
        `${BASE_URL}/api/student_record?q=${searchTerm}`
      );
    ...
    <>
      <div className="search-bar-container">
        <label className="search-label" htmlFor="searchTerm">
          Search by First Name, Middle Name, Last Name, Email, PRN, or Mobile
          Number
        </label>
        <input
      ...
      <div className="subject-container" ref={tableRef}>
          ...
          <>
              ...
              <table className="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th className="row-border">Preview</th>
                    <th className="row-border">Delete</th>
                    <th className="row-border">Edit</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredStudents.map((student, index) => (
                    <tr key={student._id}>
                      ...
                      <td
                        ...
                        style={{ color: "#008DDA", fontWeight: "bolder" }}
                      >
                        {placementData.find(
                      ...
                      <td className="row-border btn-container">
                        <NavLink to={`/profile/${student._id}`}>
                          <i className="fa-regular fa-eye preview-icon"></i>
                        </NavLink>
                      </td>
                      ...
                      <td id="BtnContainer" className="row-border btn-container">
                        <NavLink to={`/update_student_record/${student._id}`}>
                          {" "}
                          <i className="fa-solid fa-pen-to-square update-icon"></i>
                        </NavLink>
                      </td>
                    </tr>
                  ))}
            ...
            <div>
              ...
              >
                ...
                {/* Set value attribute to a number */}
